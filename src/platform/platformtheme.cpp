...
{
template<>
LINGMOUIPLATFORM_EXPORT QEvent::Type PlatformThemeEvents::DataChangedEvent::type = QEvent::None;
template<>
LINGMOUIPLATFORM_EXPORT QEvent::Type PlatformThemeEvents::ColorSetChangedEvent::type = QEvent::None;
template<>
LINGMOUIPLATFORM_EXPORT QEvent::Type PlatformThemeEvents::ColorGroupChangedEvent::type = QEvent::None;
template<>
LINGMOUIPLATFORM_EXPORT QEvent::Type PlatformThemeEvents::ColorChangedEvent::type = QEvent::None;
template<>
LINGMOUIPLATFORM_EXPORT QEvent::Type PlatformThemeEvents::FontChangedEvent::type = QEvent::None;
...
qreal PlatformTheme::frameContrast() const
{
    ...
    // the value from Ocean Qt Widget theme.
    // See: https://invent.kde.org/plasma/ocean/-/blob/master/kstyle/oceanmetrics.h?ref_type=heads#L162
    return 0.20;
}
...
PlatformTheme *PlatformTheme::qmlAttachedProperties(QObject *object)
{
    ...
    if (engine) {
        pluginName = engine->property("_lingmouiTheme").toString();
    }
