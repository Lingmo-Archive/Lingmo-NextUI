...
#ifndef LINGMOUI_PLATFORMTHEME_H
#define LINGMOUI_PLATFORMTHEME_H
...
/**
 * @class PlatformTheme platformtheme.h <LingmoUI/PlatformTheme>
 *
 * This class is the base for color management in LingmoUI,
 * different platforms can reimplement this class to integrate with
 * system platform colors of a given platform
 */
class LINGMOUIPLATFORM_EXPORT PlatformTheme : public QObject
{
    Q_OBJECT
    QML_NAMED_ELEMENT(Theme)
    QML_ATTACHED(LingmoUI::Platform::PlatformTheme)
...
Q_SIGNALS:
    ...
    void colorSetChanged(LingmoUI::Platform::PlatformTheme::ColorSet colorSet);
    void colorGroupChanged(LingmoUI::Platform::PlatformTheme::ColorGroup colorGroup);
...
private:
    LINGMOUIPLATFORM_NO_EXPORT void update();
    LINGMOUIPLATFORM_NO_EXPORT void updateChildren(QObject *item);
    LINGMOUIPLATFORM_NO_EXPORT void emitSignals();
    LINGMOUIPLATFORM_NO_EXPORT void emitColorChanged();
    LINGMOUIPLATFORM_NO_EXPORT QObject *determineParent(QObject *object);
...
template<typename T>
class LINGMOUIPLATFORM_EXPORT PropertyChangedEvent : public QEvent
{
public:
